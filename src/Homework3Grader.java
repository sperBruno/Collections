...
public class Homework3Grader
{
  ...
  public static void main(String[] paramArrayOfString) {
    org.junit.runner.Result localResult = org.junit.runner.JUnitCore.runClasses(new Class[] { CalculateScoresTest.class, CalculateSentenceScoreTest.class, AllWordsTest.class, ReadFileTest.class });
