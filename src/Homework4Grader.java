...
public class Homework4Grader {
    public static void main(String[] paramArrayOfString) {
        Result localResult = JUnitCore.runClasses(new Class[]{DepthTest.class, HeightTest.class, FindNodeTest.class, IsBalancedNodeTest.class, IsBalancedTreeTest.class});
